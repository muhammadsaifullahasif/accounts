    ...
    <div class="table-responsive trail-balance" style="height: 80vh; overflow-y: auto;">
        <table class="table table-bordered table-hover table-sm">
            ...
            <tbody>
                ...
                @endforeach
                <!-- <tr class="sub-table-row" style="display: none;" data-group-id="NCA-001">
                    <td colspan="10" class="sub-table-cell p-0">
                        <div class="sub-table-wrapper table-responsive" style="">
                            <table class="table table-striped table-bordered table-hover table-sm mb-0">
                                {{-- <thead>
                                    <tr>
                                        <th rowspan="2" style="width: 2.45%;"></th>
                                        <th rowspan="2" style="width: 24.85%;">A/C Head As Per Return</th>
                                        <th rowspan="2" style="width: 24.85%;">Notes Classification</th>
                                        <th rowspan="2" style="width: 3%;" class="text-center">Codes</th>
                                        <th colspan="2" style="width: 15%;" class="text-center">Opening</th>
                                        <th colspan="2" style="width: 15%;" class="text-center">Movement</th>
                                        <th colspan="2" style="width: 15%;" class="text-center">Closing</th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 2.45%;"></td>
                                        <td style="width: 24.85%;">
                                            <input type="hidden" name="account_code" value="PPE-001">
                                            <input type="hidden" name="account_head" value="Plant / Machinery / Equipment / Furniture (Including Fittings)">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                            Plant / Machinery / Equipment / Furniture (Including Fittings)
                                        </td>
                                        <td style="width: 22.85%;">Plant / Machinery / Equipment / Furniture (Including Fittings)</td>
                                        <td style="width: 5%;" class="text-center">PPE-001</td>
                                        <td style="width: 7.5%;" class="text-center"><input type="text" name="PPE-001-opening-debit" id="PPE-001-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td style="width: 7.5%;" class="text-center"><input type="text" name="PPE-001-opening-credit" id="PPE-001-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td style="width: 7.5%;" class="text-center"><input type="text" name="PPE-001-movement-debit" id="PPE-001-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td style="width: 7.5%;" class="text-center"><input type="text" name="PPE-001-movement-credit" id="PPE-001-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input type="hidden" name="account_code" value="PPE-002">
                                            <input type="hidden" name="account_head" value="Acc. Dep. Plant / Machinery / Equipment / Furniture (Including Fittings)">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                        </td>
                                        <td>Acc. Dep. Plant / Machinery / Equipment / Furniture (Including Fittings)</td>
                                        <td class="text-center">PPE-002</td>
                                        <td class="text-center"><input type="text" name="PPE-002-opening-debit" id="PPE-002-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-002-opening-credit" id="PPE-002-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-002-movement-debit" id="PPE-002-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-002-movement-credit" id="PPE-002-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input type="hidden" name="account_code" value="PPE-003">
                                            <input type="hidden" name="account_head" value="Plant / Machinery (Not Otherwise Specified)">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                            Plant / Machinery (Not Otherwise Specified)
                                        </td>
                                        <td>Plant / Machinery (Not Otherwise Specified)</td>
                                        <td class="text-center">PPE-003</td>
                                        <td class="text-center"><input type="text" name="PPE-003-opening-debit" id="PPE-003-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-003-opening-credit" id="PPE-003-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-003-movement-debit" id="PPE-003-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-003-movement-credit" id="PPE-003-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input type="hidden" name="account_code" value="PPE-004">
                                            <input type="hidden" name="account_head" value="Acc. Dep. Plant / Machinery (Not Otherwise Specified)">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                        </td>
                                        <td>Acc. Dep. Plant / Machinery (Not Otherwise Specified)</td>
                                        <td class="text-center">PPE-004</td>
                                        <td class="text-center"><input type="text" name="PPE-004-opening-debit" id="PPE-004-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-004-opening-credit" id="PPE-004-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-004-movement-debit" id="PPE-004-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-004-movement-credit" id="PPE-004-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input type="hidden" name="account_code" value="PPE-005">
                                            <input type="hidden" name="account_head" value="Plant / Machinery Eligible for Initial Allowance">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                            Plant / Machinery Eligible for Initial Allowance
                                        </td>
                                        <td>Plant / Machinery Eligible for Initial Allowance</td>
                                        <td class="text-center">PPE-005</td>
                                        <td class="text-center"><input type="text" name="PPE-005-opening-debit" id="PPE-005-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-005-opening-credit" id="PPE-005-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-005-movement-debit" id="PPE-005-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-005-movement-credit" id="PPE-005-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="account_code" value="PPE-001">
                                            <input type="hidden" name="account_head" value="">
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                        </td>
                                        <td>Acc. Dep. Plant / Machinery Eligible for Initial Allowance</td>
                                        <td class="text-center">PPE-006</td>
                                        <td class="text-center"><input type="text" name="PPE-006-opening-debit" id="PPE-006-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-006-opening-credit" id="PPE-006-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-006-movement-debit" id="PPE-006-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-006-movement-credit" id="PPE-006-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Furniture (Including Fittings)</td>
                                        <td class="text-center">PPE-007</td>
                                        <td class="text-center"><input type="text" name="PPE-007-opening-debit" id="PPE-007-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-007-opening-credit" id="PPE-007-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-007-movement-debit" id="PPE-007-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-007-movement-credit" id="PPE-007-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Furniture (Including Fittings)</td>
                                        <td class="text-center">PPE-008</td>
                                        <td class="text-center"><input type="text" name="PPE-008-opening-debit" id="PPE-008-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-008-opening-credit" id="PPE-008-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-008-movement-debit" id="PPE-008-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-008-movement-credit" id="PPE-008-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Technical / Professional Books</td>
                                        <td class="text-center">PPE-009</td>
                                        <td class="text-center"><input type="text" name="PPE-009-opening-debit" id="PPE-009-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-009-opening-credit" id="PPE-009-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-009-movement-debit" id="PPE-009-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-009-movement-credit" id="PPE-009-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Technical / Professional Books</td>
                                        <td class="text-center">PPE-010</td>
                                        <td class="text-center"><input type="text" name="PPE-010-opening-debit" id="PPE-010-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-010-opening-credit" id="PPE-010-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-010-movement-debit" id="PPE-010-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-010-movement-credit" id="PPE-010-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Motor Vehicle (Plying for Hire)</td>
                                        <td class="text-center">PPE-011</td>
                                        <td class="text-center"><input type="text" name="PPE-011-opening-debit" id="PPE-011-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-011-opening-credit" id="PPE-011-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-011-movement-debit" id="PPE-011-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-011-movement-credit" id="PPE-011-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Motor Vehicle (Plying for Hire)</td>
                                        <td class="text-center">PPE-012</td>
                                        <td class="text-center"><input type="text" name="PPE-012-opening-debit" id="PPE-012-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-012-opening-credit" id="PPE-012-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-012-movement-debit" id="PPE-012-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-012-movement-credit" id="PPE-012-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Ramp for Disabled Persons</td>
                                        <td class="text-center">PPE-013</td>
                                        <td class="text-center"><input type="text" name="PPE-013-opening-debit" id="PPE-013-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-013-opening-credit" id="PPE-013-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-013-movement-debit" id="PPE-013-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-013-movement-credit" id="PPE-013-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Ramp for Disabled Persons</td>
                                        <td class="text-center">PPE-014</td>
                                        <td class="text-center"><input type="text" name="PPE-014-opening-debit" id="PPE-014-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-014-opening-credit" id="PPE-014-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-014-movement-debit" id="PPE-014-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-014-movement-credit" id="PPE-014-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="group_code" value="NCA-001">
                                            <input type="hidden" name="group_name" value="Property, Plant and Equipment's">
                                            Offshore Installations of Mineral Oil Concerns
                                        </td>
                                        <td>Offshore Installations of Mineral Oil Concerns</td>
                                        <td class="text-center">PPE-015</td>
                                        <td class="text-center"><input type="text" name="PPE-015-opening-debit" id="PPE-015-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-015-opening-credit" id="PPE-015-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-015-movement-debit" id="PPE-015-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-015-movement-credit" id="PPE-015-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Offshore Installations of Mineral Oil Concerns</td>
                                        <td class="text-center">PPE-016</td>
                                        <td class="text-center"><input type="text" name="PPE-016-opening-debit" id="PPE-016-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-016-opening-credit" id="PPE-016-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-016-movement-debit" id="PPE-016-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-016-movement-credit" id="PPE-016-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Ships</td>
                                        <td class="text-center">PPE-017</td>
                                        <td class="text-center"><input type="text" name="PPE-017-opening-debit" id="PPE-017-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-017-opening-credit" id="PPE-017-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-017-movement-debit" id="PPE-017-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-017-movement-credit" id="PPE-017-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Ships</td>
                                        <td class="text-center">PPE-018</td>
                                        <td class="text-center"><input type="text" name="PPE-018-opening-debit" id="PPE-018-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-018-opening-credit" id="PPE-018-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-018-movement-debit" id="PPE-018-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-018-movement-credit" id="PPE-018-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Aircrafts / Aero Engines</td>
                                        <td class="text-center">PPE-019</td>
                                        <td class="text-center"><input type="text" name="PPE-019-opening-debit" id="PPE-019-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-019-opening-credit" id="PPE-019-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-019-movement-debit" id="PPE-019-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-019-movement-credit" id="PPE-019-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Acc. Dep. Aircrafts / Aero Engines</td>
                                        <td class="text-center">PPE-020</td>
                                        <td class="text-center"><input type="text" name="PPE-020-opening-debit" id="PPE-020-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-020-opening-credit" id="PPE-020-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-020-movement-debit" id="PPE-020-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center"><input type="text" name="PPE-020-movement-credit" id="PPE-020-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                                        <td class="text-center">0</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                </tbody>
                ...
                <tr data-group-code="NCA-001">
                    <td>
                        <a href="#" class="btn btn-sm toggle-arrow" data-group-id="NCA-001">
                            <i class="fas fa-chevron-right"></i>
                        </a>
                    </td>
                    <td><strong>Property, Plant and Equipment's</strong></td>
                    <td></td>
                    <td class="text-center">NCA-001</td>
                    <td class="text-center"><input type="text" name="001-opening-debit" id="001-opening-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                    <td class="text-center"><input type="text" name="001-opening-credit" id="001-opening-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                    <td class="text-center"><input type="text" name="001-movement-debit" id="001-movement-debit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                    <td class="text-center"><input type="text" name="001-movement-credit" id="001-movement-credit" value="0" class="form-control form-control-sm bg-transparent border-0 text-center editable"></td>
                    <td class="text-center">0</td>
                    <td class="text-center">0</td>
                </tr> -->
