        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <a href="{{ route('statements.soci.export.pdf', $company->id) }}" class="btn btn-primary btn-sm mb-3">Export PDF</a>
                    <a href="{{ route('statements.soci.export.excel', $company->id) }}" class="btn btn-primary btn-sm mb-3">Export Excel</a>
