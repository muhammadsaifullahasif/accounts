    ...
    <div class="card card-body w-50 mx-auto">
        <form action="{{ route('companies.update', $company->id) }}" method="POST" class="form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $company->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Company Nme">
                @error('name')
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $company->start_date) }}" class="form-control @error('start_date') is-invalid @enderror">
                    @error('start_date')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col mb-3">
                    ...
                    <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $company->end_date) }}" class="form-control @error('end_date') is-invalid @enderror">
                    @error('end_date')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="address" id="address" class="form-control @error('address', $company->address) is-invalid @enderror" placeholder="Enter Address">{{ old('address', $company->address) }}</textarea>
                @error('address')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <div class="form-inline">
                    <div class="custom-control custom-checkbox form-check-inline">
                        <input type="checkbox" id="sofp" value="SOFP" name="required_statements[]" class="custom-control-input" @if((old('required_statements') && in_array('SOFP', old('required_statements'))) || (!old('required_statements') && in_array('SOFP', explode(',', $company->required_statements)))) checked @endif>
                        <label for="sofp" class="custom-control-label">SOFP</label>
                    </div>
                    <div class="custom-control custom-checkbox form-check-inline">
                        <input type="checkbox" id="sopl" value="SOPL" name="required_statements[]" class="custom-control-input" @if((old('required_statements') && in_array('SOPL', old('required_statements'))) || (!old('required_statements') && in_array('SOPL', explode(',', $company->required_statements)))) checked @endif>
                        <label for="sopl" class="custom-control-label">SOPL</label>
                    </div>
                    <div class="custom-control custom-checkbox form-check-inline">
                        <input type="checkbox" id="soci" value="SOCI" name="required_statements[]" class="custom-control-input" @if((old('required_statements') && in_array('SOCI', old('required_statements'))) || (!old('required_statements') && in_array('SOCI', explode(',', $company->required_statements)))) checked @endif>
                        <label for="soci" class="custom-control-label">SOCI</label>
                    </div>
                    <div class="custom-control custom-checkbox form-check-inline">
                        <input type="checkbox" id="soce" value="SOCE" name="required_statements[]" class="custom-control-input" @if((old('required_statements') && in_array('SOCE', old('required_statements'))) || (!old('required_statements') && in_array('SOCE', explode(',', $company->required_statements)))) checked @endif>
                        <label for="soce" class="custom-control-label">SOCE</label>
                    </div>
                    <div class="custom-control custom-checkbox form-check-inline">
                        <input type="checkbox" id="socf" value="SOCF" name="required_statements[]" class="custom-control-input" @if((old('required_statements') && in_array('SOCF', old('required_statements'))) || (!old('required_statements') && in_array('SOCF', explode(',', $company->required_statements)))) checked @endif>
