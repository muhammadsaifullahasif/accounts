            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <select name="report_type" id="report_type" class="form-control @error('report_type') is-invalid @enderror">
                        ...
                        <option value="IAS 700" @if(old('report_type') === 'IAS 700') selected @endif>IAS 700</option>
                        <option value="IAS 800" @if(old('report_type') === 'IAS 7800') selected @endif>IAS 800</option>
                    </select>
                    @error('report_type')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
