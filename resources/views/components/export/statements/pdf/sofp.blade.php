            ...
            <tbody>
                ...
                @foreach ($current_assets as $current_asset)
                    ...
                    @if ($loop->first)
                        @php
                            if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'Yes') {
                                $current_year_style = `text-align: right; border-left: 1px solid #000; border-top: 1px solid #000;`;
                                $previous_year_style = `text-align: right; border-right: 1px solid #000; border-top: 1px solid #000;`;
                            } else {
                                $current_year_style = `text-align: right; border-left: 1px solid #000; border-top: 1px solid #000; border-right: 1px solid #000;`;
                            }
                        @endphp
                    @elseif ($loop->last)
                        @php
                            if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'Yes') {
                                $current_year_style = `text-align: right; border-left: 1px solid #000; border-bottom: 1px solid #000;`;
                                $previous_year_style = `text-align: right; border-right: 1px solid #000; border-bottom: 1px solid #000;`;
                            } else {
                                $current_year_style = `text-align: right; border-left: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000;`;
                            }
                        @endphp
                    @else
                        @php
                            if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'Yes') {
                                $current_year_style = `text-align: right; border-left: 1px solid #000;`;
                                $previous_year_style = `text-align: right; border-right: 1px solid #000;`;
                            } else {
                                $current_year_style = `text-align: right; border-left: 1px solid #000; border-right: 1px solid #000;`;
                            }
                        @endphp
                    @endif
                    <tr>
                        ...
                        <td style="text-align: right; {{ $current_year_style }}">
                        ...
                        @if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'Yes')
                            <td style="text-align: right; {{ $previous_year_style }}">
                ...
                <tr>
                    ...
                    <td></td>
                    <td style="text-align: right; border-top: 2px solid #000; border-bottom: 5px double #000;">
                        <strong>
                ...
                <tr>
                    ...
                    <td><strong></strong></td>
                    <td style="text-align: right; border-left: 1px solid #000; border-top: 1px solid #000; @if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'No') border-right: 1px solid #000; @endif">
                    ...
                    @if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'Yes')
                        <td style="text-align: right; border-right: 1px solid #000; border-top: 1px solid #000;">
                ...
                <tr>
                    ...
                    <td></td>
                    <td style="text-align: right; border-left: 1px solid #000; border-bottom: 1px solid #000; @if (($company->company_meta['comparative_accounts'] ?? 'Yes') == 'No') border-right: 1px solid #000; @endif">
                ...
                @foreach ($non_current_liabilities as $non_current_liability)
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><strong>{{ $non_current_liability['index'] }}</strong></td>
                        <td style="text-align: right;">
